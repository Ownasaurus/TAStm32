...
CFLAGS += -MMD -MP -MF"$(@:%.o=%.d)" -DGIT_HASH="$(shell git rev-parse HEAD)"
...
v4: C_DEFS = -DUSE_HAL_DRIVER -DSTM32F446xx -DBOARDV4
v4: $(BUILD_DIR)/$(TARGET).elf $(BUILD_DIR)/$(TARGET).hex $(BUILD_DIR)/$(TARGET).bin
